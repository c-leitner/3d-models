...
function main (params) {
    return union(
    difference(
    rectangular_extrude([ [0,30.675], [20,47.75], [52,47.75], [76.15,30.675]],
    ...
    cylinder({r:1.5,h:4,center:true, fn: params.res}).translate([20,47.75,2]),
    cylinder({r:1.5,h:4,center:true, fn: params.res}).translate([52,47.75,2]),
